...
while true; do 
  ...
  chromium-browser --kiosk --no-first-run --incognito --no-default-browser-check --disable-pinch --disable-translate --disable-features=TranslateUI --disk-cache-dir=/tmp/cache 'http://localhost'
