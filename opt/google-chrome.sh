...
while true; do 
  ...
  google-chrome --kiosk --no-first-run --incognito --no-default-browser-check --disable-pinch --disable-translate --disable-features=TranslateUI --simulate-outdated-no-au='Tue, 31 Dec 2099 23:59:59 GMT' --disk-cache-dir=/tmp/cache 'http://localhost'
